...
//     public static long est_square_sum(List<Entry> stream)
//     {   
//         double eps = 0.152;
//         Count_Sketch.bsc_init(eps);
//         foreach (Entry entry in stream)
//         {
//             Count_Sketch.bsc_process(entry.Key, entry.Value);
//         }
//         // Compute the sum of squares of all values in the table
//         long sum = 0;
//         foreach (List<Entry> entry in buckets)
//         {
//             long value = entry.Value;
//             sum += bsc_query((ulong)value);
//         }
//         return sum;
//     }
